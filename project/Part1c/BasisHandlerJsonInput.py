...
import numpy as np
from BasisHandler import BasisHandler

class BasisHandlerJsonInput(BasisHandler):
    """

    """
    def __init__(self, input_dict):
        super(BasisHandlerJsonInput,self).__init__(input_dict)
        self.input_dict = input_dict
        self.m_scheme_basis = []
        self.m_broken_basis = []
        self.sps_list = []

    def calc_sps_list(self, shell_configurations_list):
        sps_index = 1
